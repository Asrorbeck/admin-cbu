...
const ManagementDetails = () => {
  ...
  const [activeNameTab, setActiveNameTab] = useState("uz");
  ...
  const fetchManagementAndVacancies = async () => {
    try {
      ...
      // Normalize management data with multilingual fields
      const normalizedData = {
        ...managementData,
        name_uz: managementData.name_uz || managementData.name || "",
        name_cr: managementData.name_cr || "",
        name_ru: managementData.name_ru || "",
      };
      setManagement(normalizedData);
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              Boshqarma: {management.name_uz || management.name || "Noma'lum"}
            </h1>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="space-y-6">
          {/* Management Name - Multilingual with Tabs */}
          <div>
      ...
      <EditManagementModal
        ...
        onSuccess={async (updated) => {
          setManagement((prev) => ({
            ...prev,
            name_uz: updated.name_uz ?? prev.name_uz,
            name_cr: updated.name_cr ?? prev.name_cr,
            name_ru: updated.name_ru ?? prev.name_ru,
          }));
